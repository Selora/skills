...
def validate_skill(skill_path):
    ...
    # Check for Python scripts and validate pyproject.toml requirement
    scripts_dir = skill_path / "scripts"
    pyproject_toml = skill_path / "pyproject.toml"
    ...
    if has_python_scripts and not pyproject_toml.exists():
        return (
            False,
            "Python scripts found but pyproject.toml is missing. Python skills require pyproject.toml for UV dependency management.",
        )
...
if __name__ == "__main__":
    if len(sys.argv) != 2:
        ...
        print(
            "   Then run: run_python_skill.sh skill-creator quick_validate.py <skill_directory>"
        )
        print("\nComplete example:")
        print(
